...
import { UserActions } from "../../app/services/users/users.slide";
import Modal from "../../components/base/modal/Modal";
 export const UserDeleteModal = ({ id }) => {
  ...
  const contentModal = useMemo(() => {
    return (
      <div>
        <div className="modal-header">Xoá người dùng</div>
        <div className="modal-body">Bạn có muốn người dùng này?</div>
  ...
  return (
    <div className="d-flex jc-center">
      <button
        ...
        onClick={() => navigate(`/services/settings/user/edit/${id}`)}
      >
        <EditIcon />
      </button>
